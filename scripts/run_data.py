...
encoding(data_info.raw_tr_de, data_info.vocab_size, data_info.vocab_path.de, data_info.model_name.de, data_info.model_type)
encoding(data_info.raw_tr_en, data_info.vocab_size, data_info.vocab_path.en, data_info.model_name.en, data_info.model_type)
